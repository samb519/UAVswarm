#undef UAVAIRSWARM_API
#undef UAVAIRSWARM_VTABLE
...
#define UE_PROJECT_NAME UAVAirSwarm
...
#define UAVAIRSWARM_VTABLE DLLEXPORT_VTABLE
#define UAVAIRSWARM_API DLLEXPORT
